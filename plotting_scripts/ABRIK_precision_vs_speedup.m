...
function[] = ABRIK_precision_vs_speedup()
    ...
    filename = "../benchmark_output_abrik_paper/SapphireRapids/dense/_ABRIK_speed_comparisons_num_info_lines_6.txt";
    Data_in = readfile(filename, 6);
    
    % We have a total of 6 synthetic test matrices.
    plot_position = 1;
    for i = 1:num_test_matrices
        figure

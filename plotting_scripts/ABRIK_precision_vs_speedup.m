...
function[] = abrik_precision_vs_speedup(filename, num_b_sizes, num_krylov_iters, num_iters, err_type, test_matrix_number, plot_all_b_sz, show_lables)
    ...
    nexttile
    plot_2d(Data_in(num_iters*num_krylov_iters*num_b_sizes*(i-1)+1:num_iters*num_krylov_iters*num_b_sizes*i, :), num_iters, num_b_sizes, num_krylov_iters, 6, err_type, "speedup_over_svd", plot_all_b_sz, show_lables, 2);
    plot_position = plot_position + 1;
    % Plots RSVD digits of accuracy vs speedup over SVD.
    nexttile
    plot_2d(Data_in(num_iters*num_krylov_iters*num_b_sizes*(i-1)+1:num_iters*num_krylov_iters*num_b_sizes*i, :), num_iters, num_b_sizes, num_krylov_iters, 9, err_type, "speedup_over_svd", plot_all_b_sz, show_lables, 3);
    plot_position = plot_position + 1;
    % Plots SVDS digits of accuracy vs speedup over SVD.
    nexttile
    plot_2d(Data_in(num_iters*num_krylov_iters*num_b_sizes*(i-1)+1:num_iters*num_krylov_iters*num_b_sizes*i, :), num_iters, num_b_sizes, num_krylov_iters, 12, err_type, "speedup_over_svd", plot_all_b_sz, show_lables, 4);
end

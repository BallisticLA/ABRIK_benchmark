...
figure('Name', ['mat1_abrik_precision_vs_speedup_mat_' num2str(1)], 'NumberTitle', 'off');
filename = CPU_path_1 + "sparse/" + benchmarking_date + "Mat1_ABRIK_speed_comparisons_sparse_num_info_lines_6.txt";
abrik_precision_vs_speedup_sparse(filename, 4, 4, 3, 1, 1, 0);
fig_save(gcf, fig_path, 10, 10);

figure('Name', '_abrik_runtime_breakdown_sparse', 'NumberTitle', 'off');
